...
if (isset($_GET['id'])) {
   $getfood = $food->findOne(['_id' => new MongoDB\BSON\ObjectID($_GET['id'])]);
}
...
if(isset($_POST['submit'])){
   ...
   $food->updateOne(
       ...
       ['$set' => ['food' => $_POST['food'], 'price' => $_POST['price'],]]
			...
			<div class="row">
				<div class="column">
					<div class="card">
						...
						<div class="container">
							<form method ="post" onSubmit="alert('Your order has been changed!');">
